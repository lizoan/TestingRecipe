...
import com.lizoan.testingrecipe.fragments.AboutFragment;

/**
 * Created by Ivan on 8/13/2017.
 */

public class AboutActivity extends AppCompatActivity implements AboutFragment.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState == null) {
            // Create an instance of AboutFragment and add it to the activity
