...
import com.lizoan.testingrecipe.adapters.DetailPagerAdapter;
import com.lizoan.testingrecipe.fragments.InfoFragment;
import com.lizoan.testingrecipe.fragments.SummaryFragment;
import com.lizoan.testingrecipe.utils.FavoritesDBHelper;
...
public class DetailsActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private RecipesDBHelper dbhelperRecipes;
    private FavoritesDBHelper dbhelperFavorites;

    // Create instance of adapter
    private DetailPagerAdapter adapterDetailPager;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lytTitle = findViewById(R.id.lytTitle);
        ...
        dbhelperRecipes = new RecipesDBHelper(this);
        dbhelperFavorites = new FavoritesDBHelper(this);
        ...
        switch(v.getId()){
            case R.id.btnFavorite:
                if(dbhelperFavorites.isDataAvailable(selectedId)) {
                    ...
                    new MaterialDialog.Builder(DetailsActivity.this)
                            ...
                            .callback(new MaterialDialog.ButtonCallback() {
                                ...
                                public void onPositive(MaterialDialog dialog) {
                                    ...
                                    if (result) {
                                        new SnackBar(DetailsActivity.this, getString(R.string.success_remove)).show();
                                        btnFavorite.setIconDrawable(getResources().getDrawable(R.drawable.ic_favorite_white_36dp));
                                        dialog.dismiss();
                                    }
                                }
                    ...
                    if(result){
                        new SnackBar(DetailsActivity.this, getString(R.string.success_add_data)).show();
                        btnFavorite.setIconDrawable(getResources().getDrawable(R.drawable.ic_favorite_outline_white_36dp));
                    }
                }
                break;
    ...
    public void createPager(){
        pagerFragments.add(SummaryFragment.newInstance(cookTime, servings, summary));
        pagerFragments.add(InfoFragment.newInstance(ingredients));
        pagerFragments.add(InfoFragment.newInstance(steps));

        adapterDetailPager = new DetailPagerAdapter(getSupportFragmentManager(), this, pagerFragments);
