...
import com.lizoan.testingrecipe.adapters.RecipesAdapter;
...
public class RecipesFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dbhelperRecipes = new RecipesDBHelper(getActivity());
        dbhelperFavorites = new FavoritesDBHelper(getActivity());
        ...
        adapterRecipes = new RecipesAdapter(getActivity());
